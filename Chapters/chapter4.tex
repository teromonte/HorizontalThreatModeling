...
\begin{itemize}
    ...
    through the system map from \hyperref[subsec:Step2]{Step 2} and pausing at each component or
    boundary to ask what could go wrong. For example, when examining the database, consider
